...
import ErorRohit from "./Components/ErorRohit";
function App() {
  let ary = [
    {
      maintitle: "ANGULAR",
      to: "angular",
      img: require("./Assets/Images/Courses/img1.jpg"),
      strong: "Angular JS",
      p1: ` is a JavaScript framework with a lot of capability. Single Page Application (SPA) developments make use of it. It adds extra characteristics to the HTML DOM and makes it more responsive to user activities. AngularJS is an open source framework that is absolutely free to use, and it is utilised by thousands of developers all over the world. It is distributed under the Apache License 2.0.`,
      heading: "Why to Learn AngularJS?",
      p2: "Angular JS is a free and open-source framework for building online applications. Misko Hevery and Adam Abrons came up with the idea in 2009. It is now Google’s responsibility to keep it up to date.",
      p3: "Angular JS is a powerful framework for building Rich Internet Applications (RIA).",
      p4: "Angular JS gives developers the ability to construct elegant Model View Controller (MVC) client-side apps using JavaScript.Angular JS-based applications are cross-browser compatible. AngularJS processes JavaScript code in a browser-agnostic manner.",
      p5: "Angular JS is an open source framework that is absolutely free to use, and it is utilised by thousands of developers all over the world. It is distributed under the Apache License 2.0.",
      p6: "Angular JS is a framework for developing large-scale, high-performance, and simple-to-maintain web applications.",
      accordian: [
        {
          eventkey: 1,
        ...
        },
        {
          items: [
            ...
            "Why MVC matters",
            "MVC-The Angular way",
            "Features of Angular, Model-View-Controller",
        ...
        {
          items: [
            "Built-In Filters, Using Angular Filters",
        ...
        {
          items: ["Introduction to Angular Modules", "Bootstrapping Angular"],
          eventkey: 10,
    ...
    },
    {
      maintitle: "REACT JS",
      to: "reactJS",
      img: require("./Assets/Images/Courses/img2.png"),
      strong: "React JS",
      p1: " is a JavaScript toolkit that allows you to create reusable user interface components. The following is the definition from the official React documentation:",
      heading: "Why we use React JS?",
      p2: "The primary goal of React JS is to create User Interfaces (UI) that increase app speed. It makes use of virtual DOM (JavaScript object), which increases the app’s performance. The virtual DOM in JavaScript is faster than the conventional DOM. React JS can be used on the client and server side, as well as in conjunction with other frameworks. It employs component and data patterns to improve readability while also assisting in the maintenance of larger apps.",
      p3: "React Advantages",
      p4: "Uses a JavaScript object called virtual DOM. Because JavaScript virtual DOM is quicker than the conventional DOM, this will increase app speed.",
      p5: "It’s compatible with different frameworks and may be used both on the client and server side.",
      p6: "Component and data patterns promote readability, which makes larger apps easier to manage.",
      accordian: [
        {
          eventkey: 1,
          title: "ES6 Overview",
        ...
        {
          eventkey: 11,
          title: "Immutable.Js For Immutable Data Structures",
          items: [
        ...
        {
          eventkey: 13,
          title: "Redux Saga(Redux Middleware)",
          items: [
    ...
    },
    {
      maintitle: "NODE JS",
      to: "nodeJS",
      img: require("./Assets/Images/Courses/img3.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
      ...
      p5: "",
      p6: "",
      accordian: [{ eventkey: 1, title: "", items: [] }],
    },
    {
      maintitle: "FLUTTER",
      to: "flutter",
      img: require("./Assets/Images/Courses/img4.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
    ...
    },
    {
      maintitle: "VUE JS",
      to: "vueJS",
      img: require("./Assets/Images/Courses/img9.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
    ...
    },
    {
      maintitle: "CORE PHP",
      to: "corePHP",
      img: require("./Assets/Images/Courses/img12.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
    ...
    {
      maintitle: "CODEIGNITER (PHP FRAMEWORK)",
      to: "codeigniter",
    ...
    {
      maintitle: "LARAVEL (PHP FRAMEWORK)",
      to: "laravel",
    ...
    },
    {
      maintitle: "ANDROID",
      to: "android",
      img: require("./Assets/Images/Courses/img15.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
    ...
    },
    {
      maintitle: "IOS",
      to: "ios",
      img: require("./Assets/Images/Courses/img16.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
    ...
    },
    {
      maintitle: "C++ PROGRAMMING",
      to: "c++",
      img: require("./Assets/Images/Courses/img19.png"),
      p1: "",
      heading: "",
      p2: "",
      p3: "",
  ...
  //   }
  // };
  let loginNum = JSON.parse(localStorage.getItem("loginnum"))
  return (
    <>
